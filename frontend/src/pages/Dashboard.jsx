...
export default function Dashboard({ jarvis }) {
  return <motion.main className="dashboard-page" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.35 }}>
    <div className="dashboard-grid">
      <div className="dashboard-left"><SystemStatus stats={jarvis.stats} /><AIConsole messages={jarvis.messages} isListening={jarvis.isListening} isProcessing={jarvis.isProcessing} onToggleListening={jarvis.toggleListening} onSubmit={jarvis.submitCommand} /><RecentActivity activity={jarvis.activity} /></div>
